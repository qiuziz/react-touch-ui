...
export class Scroll extends React.Component {
    ...
    static propTypes = {
        ...
        isHorizontal: PropTypes.bool.isRequired,  // 是否水平scroll
        isFill: PropTypes.bool  // 是否内容填充
    };
    ...
    //console.log("iipppppppppppppppppp",w1,w2,h1,h2);
        return (
            ...
            <View w={w1} h={h1} bgColor={bgColor} isFill={isFill} baseStyle={ {overflow: "hidden",position:"relative" }}>
